    ...
    <div className="bg-gray-800 border-b border-gray-700 px-6 py-1 flex justify-between items-center shadow-lg">
      <div className="flex items-center gap-3">
        <div className="flex items-center justify-center">
          <img src="/liard_logo_png.png" alt="CAD Icon" className="h-20 w-auto shadow-md rounded-lg" />
        </div>
        <div>
          <h1 className="text-xl font-semibold text-white">DWG Analysis Assistant</h1>
          <p className="text-sm text-gray-400">AI-powered CAD file analysis</p>
        </div>
      </div>
      <div className="flex items-center gap-3">
        {dwgId && (
